...
gcc ./functions/Standard_Shell_functions/Math.c -o ./functions/Standard_Shell_functions/Math -lm
...
gcc ./functions/Logic_Shell_functions/DectoBin.c -o ./functions/Logic_Shell_functions/DectoBin -lm
...
gcc ./functions/Math_Shell_functions/Power.c -o ./functions/Math_Shell_functions/Power -lm
gcc ./functions/Math_Shell_functions/Solve.c -o ./functions/Math_Shell_functions/Solve -lm
gcc ./functions/Math_Shell_functions/Sqrt.c -o ./functions/Math_Shell_functions/Sqrt -lm
